...
<section class="examples">
    ...
    <article class="margins">
        ...
        <div class="m3 bg-navy c-white">m3</div>
        <div class="m4 bg-navy c-white">m4</div>
     ...
     <article class="margins">
        ...
        <div class="mt3 bg-navy c-white">mt3</div>
        <div class="mt4 bg-navy c-white">mt4</div>
    ...
    <article class="margins">
        ...
        <div class="mr3 bg-navy c-white">mr3</div>
        <div class="mr4 bg-navy c-white">mr4</div>
    ...
    <article class="margins">
        ...
        <div class="mb3 bg-navy c-white">mr3</div>
        <div class="mb4 bg-navy c-white">mr4</div>
    ...
    <article class="margins">
        ...
        <div class="mx3 bg-navy c-white">mr3</div>
        <div class="mx4 bg-navy c-white">mr4</div>
    ...
    <article class="margins">
        ...
        <div class="my3 bg-navy c-white">mr3</div>
        <div class="my4 bg-navy c-white">mr4</div>
        <div class="my5 bg-navy c-white">mr5</div>
    </article>
